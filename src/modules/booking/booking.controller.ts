...
export class BookingController {
    ...
    @ApiQuery({ name: 'status', required: false, enum: BookingStatus, description: 'Lọc theo trạng thái booking' })
    async findAll(
        ...
        return this.bookingService.getAllBookingsForAdmin(page, limit, search, status);
    }
